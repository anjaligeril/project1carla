...
<?php
	...
	*/
	...
	if(isset($_POST['frmAddStudent']))
	{
		...
		$dbObj = mysql_select_db('carlas_class', $dbConn);
		...
		$sqlStatement="INSERT INTO students (last_Name, first_Name, contact_Email, grade_Math , grade_Read , grade_Write , comment) VALUES ('$_POST[lastName]','$_POST[firstName]','$_POST[contactEmail]','$_POST[gradeMath]','$_POST[gradeRead]','$_POST[gradeWrite]','$_POST[comment]')";
